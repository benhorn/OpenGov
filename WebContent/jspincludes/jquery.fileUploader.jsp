...
(function($) {
	...
	$.fn.fileUploader = function(config){
		...
		config = $.extend({}, {
			...
			selectFileLabel: 'Add files',
			allowedExtension: 'pdf|jpg|jpeg|rtf|doc|png|docx|odf|tif|xls|ppt',
			...
			{
				$("#displayTable").load('agency_pages/displayTable.jsp?id=<%=id%>');
