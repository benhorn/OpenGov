...
public class TikaWrapper extends BaseLog{
	 ...
	 * @throws IOException
	 */
	public String getPageNumber(String filePath)
	{
		...
		try {
			...
			logger.info("In class TikeWrapper: getPageNumber()");
			e.printStackTrace();
		}
		return metaData.get("xmpTPg:NPages");
	}
	...
	public String getFileSize(String filePath)
	{
		...
		try {
			...
			logger.info("In class TikeWrapper: getFileSize()");
			e.printStackTrace();
		}
		return metaData.get("Content-Length");
	}
