...
<div class="PageTitle"><h1>Thank you</h1></div>
        
<div class="ContextInformation">
</div>

<div class="SiteContent">
<p>Thank you for registering with OpenGov. An email confirming your login details will be sent to you shortly, but you can proceed immediately to <a href="agency_login" title="Title">log in</a> and perform uploads.</p>
</div>
