...
$(document).ready(function() {
 $("#registration_form").attr('autocomplete','off');
});
//-->
</script>
...
function checkLoginName(){
	...
	var result = jsonrpc.ajaxBean.chkLoginName(lname);
	if ((lname != null) && (lname.length > 0) && (!result)){
...
<div id="flag"></div>
	<html:form action="/reg?method=register" styleId="registration_form" method="post">
	<fieldset>
