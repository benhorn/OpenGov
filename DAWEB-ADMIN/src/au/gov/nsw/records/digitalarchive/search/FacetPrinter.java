...
public class FacetPrinter {
  ...
  public FacetsCollector getFacetsCollector() throws IOException {
    ...
    CategoryPath publication_year = new CategoryPath("publication_year");*/
    ...
    FacetRequest TypeFacetRequest = new CountFacetRequest(type, 10);
    FacetRequest RightsFacetRequest = new CountFacetRequest(rights, 10);
    ...
    facetSearchParams.addFacetRequest(TypeFacetRequest);
    facetSearchParams.addFacetRequest(RightsFacetRequest);
