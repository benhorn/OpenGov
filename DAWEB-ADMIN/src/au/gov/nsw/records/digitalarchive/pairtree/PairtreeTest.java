package au.gov.nsw.records.digitalarchive.pairtree;
...
public class PairtreeTest {
	...
	public static void main(String[] args)
	{
		...
		System.out.println(idOne.toString().replaceAll("-", "") + " " + idOne.toString().length());
		System.out.println(pt.mapToPPath(idOne.toString().replaceAll("-", "")));
		String pDir = pt.mapToPPath(idOne.toString().replaceAll("-", ""));
		File newFile = new File("c:/pairtree/" + pDir);
		newFile.mkdirs();
	}
