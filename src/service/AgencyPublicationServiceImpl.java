...
public class AgencyPublicationServiceImpl extends BaseLog implements AgencyPublicationService{
	...
	public static void main(String[] args) throws Exception
	{
		...
		FullAgencyList fList = new FullAgencyList();
		AgencyPublicationService aps = new AgencyPublicationServiceImpl();
		fList.setFullAgencyListId(25006);	
		
		List<Publication> pub = aps.loadPublicationViaFullAgency(fList);
					
		System.out.println("System:" + pub.get(0).getTitle());
	}
